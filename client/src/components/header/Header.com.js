...
function MyVerticallyCenteredModal(props) {
  return (
    <C.Modal
      ...
      centered
    >
      <C.Modal.Header closeButton>
        <C.Modal.Title id='contained-modal-title-vcenter'>
          Privacy And Policy
        </C.Modal.Title>
      </C.Modal.Header>
      <C.Modal.Body>
        <p>
          Sepay built the Wonder W app as a Free app. This SERVICE is provided by Sepay at
        ...
        <p>
          ...
          Conditions, which is accessible at Wonder W unless otherwise defined in this
          Privacy Policy.
        </p>
        <p>
        ...
        <p>
          ...
          to UUID of the device for Unity Analytics. The information that we request will
        ...
        <p>This policy is effective as of 2021-08-31</p>{" "}
        <p>
          <strong>Contact Us</strong>
        </p>{" "}
        <p>
          If you have any questions or suggestions about our Privacy Policy, do not
          hesitate to contact us at sepayteam@gmail.com.
        </p>{" "}
        <p>
      ...
      <C.Modal.Footer>
        <C.Button onClick={props.onHide}>Close</C.Button>
      </C.Modal.Footer>
    </C.Modal>
  );
}
        ...
        <C.Container>
          ...
          <C.Navbar.Collapse id='responsive-nav'>
            <C.Nav className='ms-auto'>
              ...
              <C.Nav.Link onClick={() => setModalShow(true)}>Privacy & Policy</C.Nav.Link>
            </C.Nav>
          </C.Navbar.Collapse>
        </C.Container>
      </C.Navbar>
